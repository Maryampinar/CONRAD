...
public class Intro {
	...
	public static void gridIntro(){
		...
		for (int x= 0; x < imageSizeX; x++)
		{
			for (int y =0; y < imageSizeY; y++)
					{
						if(Math.pow(x- (imageSizeX/2.f),2) + Math.pow(y - (imageSizeY/2f),2) < Math.pow(radius, 2))
						{
		...
		String filename = "/proj/ciptmp/we08qame/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";
		...
		String outFilename ="/home/cip/2008/cimaboeg.......D:/02_lectures/DMIP/exercises/2014/matlab_intro/mr12out.tif";
	...
	public static void basicIntro()
	{
		...
		SimpleVector vecL2 = colVector.normalizedL2();		//normalize vector in-place
